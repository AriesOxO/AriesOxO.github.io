...
```java
package com.xieteng.biz.config;
...
//        servletRegistrationBean.addInitParameter("loginPassword", "1008611");
...
```java
@Bean(name = "vteDataSource", initMethod = "init", destroyMethod = "close")
...
public class DruidAspectConfig {
    ...
    public JdkRegexpMethodPointcut druidStatPointcut() {
        ...
        //AOP 切入点
        pointcut.setPatterns("com.xieteng.dal.mapper.*", "com.xieteng.server.business.*");
        return pointcut;
    }
